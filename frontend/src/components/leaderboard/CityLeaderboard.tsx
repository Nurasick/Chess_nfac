...
export function CityLeaderboard({ city, page }: CityLeaderboardProps) {
  const { t } = useTranslation()

  const { data, isLoading, isError } = useQuery({
    queryKey: ['leaderboard', city, page],
    queryFn: () =>
      get<PaginatedResponse<LeaderboardEntry>>(`/leaderboard/${city}?page=${page}&page_size=20`),
  })
  ...
  return (
    <div className={styles.list} data-testid="city-leaderboard">
